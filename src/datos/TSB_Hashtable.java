 ...
 * en forma nativa por Java. Una TSB_Hashtable usa un arreglo de listas de la
 ...
 * arreglo. En nuestra clase TSB_Hashtable, mantuvimos el concepto de loadFactor
 ...
 */
public class TSB_Hashtable<K,V> implements Map<K,V>, Cloneable, Serializable
{
     ...
     */    
    public TSB_Hashtable(int initial_capacity)
    {
     ...
     */
    public TSB_Hashtable(int initial_capacity, float load_factor)
    {
        if(load_factor <= 0) { load_factor = 0.8f; }
        if(initial_capacity <= 0) { initial_capacity = 11; }
        else
        {
            if(initial_capacity > TSB_Hashtable.MAX_SIZE)
            {
                initial_capacity = TSB_Hashtable.MAX_SIZE;
            }
        }
     ...
     */     
    public TSB_Hashtable(Map<? extends K,? extends V> t)
    {
        this(11, 0.8f);
        this.putAll(t);
    }
    ...
    {
        TSB_Hashtable<K, V> t = (TSB_Hashtable<K, V>)super.clone();
    ...
    protected void rehash()
    {
        ...
        if(new_length > TSB_Hashtable.MAX_SIZE)
        { 
            new_length = TSB_Hashtable.MAX_SIZE;
        }
    ...
    private class KeySet extends AbstractSet<K> 
    {
        ...
        public int size() 
        {
            return TSB_Hashtable.this.count;
        }
        
        @Override
        public boolean contains(Object o) 
        {
            return TSB_Hashtable.this.containsKey(o);
        }
        
        @Override
        public boolean remove(Object o) 
        {
            return (TSB_Hashtable.this.remove(o) != null);
        }
        
        @Override
        public void clear() 
        {
            TSB_Hashtable.this.clear();
        }
        ...
        private class KeySetIterator implements Iterator<K>
        {
            ...
            public KeySetIterator()
            {
                ...
                current_entry = -1;
                next_ok = false;
                expected_modCount = TSB_Hashtable.this.modCount;
            }
            ...
            public boolean hasNext() 
            {
                ...
                TSBArrayList<Map.Entry<K, V>> t[] = TSB_Hashtable.this.table;

                if(TSB_Hashtable.this.isEmpty()) { return false; }
            ...
            public K next() 
            {
                ...
                if(TSB_Hashtable.this.modCount != expected_modCount)
                {    
            ...
            public void remove() 
            {
                ...
                Map.Entry<K, V> garbage = TSB_Hashtable.this.table[current_bucket].remove(current_entry);

                // quedar apuntando al anterior al que se retornó...                
                if(last_bucket != current_bucket) 
                {
                    current_bucket = last_bucket;
                    current_entry = TSB_Hashtable.this.table[current_bucket].size() - 1;
                }
                ...
                TSB_Hashtable.this.count--;

                // fail_fast iterator: todo en orden...
                TSB_Hashtable.this.modCount++;
                expected_modCount++;
            }     
        }
    }
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> 
    {
        ...
        public boolean contains(Object o) 
        {
            ...
            K key = entry.getKey();
            int index = TSB_Hashtable.this.h(key);

            TSBArrayList<Map.Entry<K, V>> bucket = TSB_Hashtable.this.table[index];
    ...
    private class ValueCollection extends AbstractCollection<V> 
    {
        ...
        public boolean contains(Object o) 
        {
            return TSB_Hashtable.this.containsValue(o);
        }
